...
export const OLD_SCHOOL_PRICING = {
  mode: "Fixed price",
  amount: "100",
  token: "USDC",
  billingPeriod: "month",
...
export function buildOldSchoolAgentUri(agent: TrustedOldSchoolAgent): string {
  return JSON.stringify({
    ...
    pricingMode: OLD_SCHOOL_PRICING.mode,
    primaryToken: OLD_SCHOOL_PRICING.token,
    fixedPriceAmount: OLD_SCHOOL_PRICING.amount,
    billingPeriod: OLD_SCHOOL_PRICING.billingPeriod,
